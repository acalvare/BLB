 ...
 * 
 */
@WebServiceClient(name = "MarketImplService", targetNamespace = "http://workflow.server/", wsdlLocation = "http://localhost:8080/WS/Market?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/WS/Market?wsdl");
