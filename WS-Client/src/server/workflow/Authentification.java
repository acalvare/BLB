 ...
 * 
 */
@WebService(name = "Authentification", targetNamespace = "http://interfaces.server/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface Authentification {
    ...
    @Action(input = "http://interfaces.server/Authentification/authenticateRequest", output = "http://interfaces.server/Authentification/authenticateResponse")
