 ...
 * generated in the server.interfaces package. 
...
public class ObjectFactory {
    ...
    private final static QName _Authenticate_QNAME = new QName("http://interfaces.server/", "authenticate");
    private final static QName _AuthenticateResponse_QNAME = new QName("http://interfaces.server/", "authenticateResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: server.interfaces
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server/", name = "authenticate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces.server/", name = "authenticateResponse")
